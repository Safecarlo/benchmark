...
# ieee
VFC_BACKENDS="libinterflop_ieee.so" taskset -c $core ./main 1.0 1.0 2> ieee_tmp.txt
...
# vprec normal
VFC_BACKENDS="libinterflop_vprec.so" taskset -c $core ./main 1.0 1.0 2> vprec_normal_tmp.txt
...
# vprec full normal
VFC_BACKENDS="libinterflop_vprec.so --mode=full" taskset -c $core ./main 1.0 1.0 2> vprec_full_normal_tmp.txt

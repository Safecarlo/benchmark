...
# ieee
VFC_BACKENDS="libinterflop_ieee.so" taskset -c 1 ./main 1.0 1.0 2> ieee_tmp.txt
...
# vprec normal
VFC_BACKENDS="libinterflop_vprec.so" taskset -c 1 ./main 1.0 1.0 2> vprec_normal_tmp.txt
...
# vprec denormal
VFC_BACKENDS="libinterflop_vprec.so" taskset -c 1 ./main 0x1.0p-130 0x1.0p-130 2> vprec_denormal_tmp.txt
...
# vprec full normal
VFC_BACKENDS="libinterflop_vprec.so --mode=full" taskset -c 1 ./main 1.0 1.0 2> vprec_full_normal_tmp.txt
...
# vprec full denormal
VFC_BACKENDS="libinterflop_vprec.so --mode=full" taskset -c 1 ./main 0x1.0p-130 0x1.0p-130 2> vprec_full_denormal_tmp.txt
